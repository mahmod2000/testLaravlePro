            ...
            <table class="table table-bordered table-hover">
                ...
                @foreach($posts as $post)
                    <tr id="box_{{$post->id}}">
                        ...
                        <td>@if($post->enabled) <i class="fa fa-check" aria-hidden="true"></i> @else <i class="fa fa-times" aria-hidden="true"></i>
                            @endif
                        </td>
                        <td>
                            ...
                            <a class="btn btn-primary btn-sm" href="{{route('admin.ConfirmPost', $post->id)}}">
                                @if($post->enabled == 0) <i class="fa fa-cog"></i> فعال کردن پست </a>
